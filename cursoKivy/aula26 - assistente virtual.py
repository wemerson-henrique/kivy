...
class Menu(Screen):
    ...
    def confirmacao(self, *args, **kwargs):
        ...
        animText.start(sim)
        # Qual quer propriedade do widget pode ser animada
...
popSound = SoundLoader.load('sons/pop.mp3')
poppapSound = SoundLoader.load('sons/poppap.mp3')
